...
(function($) {
    ...
    $.widget('ui.tagit', {
        ...
        createTag: function(value, additionalClass, duringInitialization) {
            ...
            /******Modified********************/
            var label = $(this.options.onTagClicked ? '<a class="tagit-label"></a>' : '<a class="tagit-label"></a>').text(value);
            /**************************/
            // Create tag.
            var tag = $('<li></li>')
...
/*
keeex self xopav-feniz-sugot-cikum-locin-ninak-fabin-togid-farov-ryfud-robac-kogub-hehor-dyvyn-lavec-kubyg-bixyx , {main} xeeek
keeex self 35eckARBTtXx4eTMyUTc1V3DMUVwArE8Fxxyha3 , {alg:sha224,enc:b58,recursive:1} xeeek
keeex name "tag-it.js" , {main} xeeek
...
keeex prop "kx.time", "Fri, 12 Aug 2016 09:38:35 GMT" xeeek
keeex prop "kx.pattern", "%f_kx_$1-$2" xeeek
keeex prop "kx.publickey", "1Lht9GuEcDvF3m7WUUv8igY4zKcQs6tyBR", {bitcoin} xeeek
keeex protected "GzFRVLsVyrA:ohQYRcCgxHXm4PA4cqIrCpZpxopnz89zkzwCi2lc!NpYjDJCQqPI1x9Qe3bcKt9reDFPzKbgRTE=" , {bitcoin} xeeek
